...
// This configuration was automatically generated by CounterStrikeSharp for plugin 'PlayerModelChanger', at 2024/02/23 11:41:05
{
  "Models": {
	...
	"vipmodel": { // 一个简单的vip模型
		...
		"permissions": ["@vip/flag1", "@vip/flag2"] // !!注意，VIP玩家必须同时拥有@vip/flag1和@vip/flag2两个flag
		// "permissionsOr": ["@vip/flag1", "@vip/flag2"] // 如果你使用这个配置替代上面的permissions, vip玩家只需要有其中一个flag
	}
	"mymodel": { // 最简单的例子
		"path": "characters/XXX/mymodel.vmdl"
	} 
  },
  "MenuType": "centerhtml", // 菜单类型, "chat" 或者 "centerhtml", 默认 "centerhtml"
